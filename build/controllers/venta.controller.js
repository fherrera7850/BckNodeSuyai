...
var getBoletaDiaria = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var Fecha, connection, fechaFormateadaYYYYMMDD, qry, _yield$connection$que15, _yield$connection$que16, result, fields, response;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 4:
            ...
            fechaFormateadaYYYYMMDD = (0, _moment["default"])(Fecha).format("YYYY-MM-DD");
            qry = "select\n        round((sum(v.PrecioTotalVenta) * 0.9)) as MontoBoleta\n        from venta v inner join pedido p on p.Venta_id=v._id \n        where p.Estado = 'C' and DATE(CONVERT_TZ(v.Fecha, 'UTC', 'America/Buenos_Aires')) = '".concat(fechaFormateadaYYYYMMDD, "' and v.MedioPago <> 2;");
            _context6.next = 9;
            return connection.query(qry);
          ...
          case 9:
            ...
            response = {
              "Fecha": (0, _moment["default"])(Fecha).format("DD-MM-YYYY"),
          ...
          case 18:
            ...
            res.status(500);
            res.send(_context6.t0.toString());
  ...
  return function getBoletaDiaria(_x11, _x12) {
...
var methods = {
  ...
  getBoletaDiaria: getBoletaDiaria
};
